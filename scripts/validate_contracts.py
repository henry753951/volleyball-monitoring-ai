...
def main() -> None:
    ...
    example_pairs = {
        ...
        "examples/ai/provider-analysis-job.json": "ai/provider-analysis-job.schema.json",
        "examples/ai/person-pose-evidence-manifest.json": "ai/person-pose-evidence-manifest.schema.json",
        "examples/ai/player-crop-source-manifest.json": "ai/player-crop-source-manifest.schema.json",
