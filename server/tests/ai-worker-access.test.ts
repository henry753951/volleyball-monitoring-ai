...
import { authenticateAiIntegrationToken, createAiWorkerToken } from '../src/services/ai-worker-access.js'
...
describe('AI worker access tokens', () => {
  ...
  it('creates another credential inside an existing worker pool', async () => {
