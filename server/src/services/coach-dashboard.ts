  ...
  return {
    ...
    match: {
      ...
      sets: match.sets.map(set => ({
        ...
        left_score: set.leftScore,
        right_score: set.rightScore,
      ...
      drafts: drafts.map(draft => ({
        ...
        left_team_id: draft.sideAssignmentReversed
          ? draft.sideAssignment.rightTeamId
          : draft.sideAssignment.leftTeamId,
        right_team_id: draft.sideAssignmentReversed
          ? draft.sideAssignment.leftTeamId
          : draft.sideAssignment.rightTeamId,
        set_id: draft.set.id,
          ...
          ? [
              {
                ...
                scoring_team_id: rally.scoringTeamId,
                set_id: rally.set.id,
                ...
                submission: {
                  ...
                  scoring_court_side:
                    rally.activeSubmission.scoringCourtSide?.toLowerCase() ?? null,
                  scoring_team_id: rally.activeSubmission.scoringTeamId,
                  ...
                  processing: (() => {
                    ...
                    return {
                      ...
                      analysis_id:
                        displayResultBySubmissionId.get(rally.activeSubmission.id)?.analysis?.id ??
                        null,
