...
<style scoped>
.court-view{border:0;border-radius:0;background:#0d1319;box-shadow:none}.court-view::before{background:radial-gradient(circle at 50% 38%,#ffffff09,transparent 58%)}.court-heading{padding-inline:13px}.court-path__curve{stroke-dasharray:3.5 4.5}.court-nameplate rect,.court-endpoint-labels rect{fill:#090e13f2;stroke:#ffffff2b}.court-player:not(.hitter){opacity:.25}
</style>
