...
describe('DvrTimelineDock mounted interactions', () => {
  ...
  it('keeps the current immutable Rally AI result rail when its duplicate segment mask is suppressed', async () => {
    ...
    const w = mount(DvrTimelineDock, { props: {
      timeline, playhead: '1750', annotation: current, segments: [analyzedSegment],
      maskRange: { startCaptureTimeUs: '1200', endCaptureTimeUs: '1900' }, selectedSegmentId: 'rally',
    } })
  ...
  it('keeps correction-draft service and contact markers editable', () => {
    ...
    const w = mount(DvrTimelineDock, { props: { timeline, playhead: null, annotation: correction, editable: true } })
