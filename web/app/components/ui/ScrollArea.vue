...
.scroll-area :deep(.scroll-area__viewport) {
  position: absolute;
  inset: 0;
  width: 100%;
  height: auto;
...
.scroll-area.horizontal :deep(.scroll-area__viewport) {
  position: relative;
  inset: auto;
  height: auto;
}
...
.scroll-area :deep(.scroll-area__thumb)::before {
  position: absolute;
  top: 50%;
  left: 50%;
  width: 100%;
