...
.match-identity h2{overflow:visible;line-height:1.35;text-overflow:clip;white-space:normal;overflow-wrap:anywhere}.match-identity p{overflow-wrap:anywhere}.match-actions{min-width:108px;display:grid;align-items:stretch}.annotate-action{height:auto;min-height:34px;padding-block:7px;text-align:center}.match-menu summary{width:100%}.scoreboard div span{overflow:visible;line-height:1.35;text-overflow:clip;white-space:normal;overflow-wrap:anywhere}
</style>
