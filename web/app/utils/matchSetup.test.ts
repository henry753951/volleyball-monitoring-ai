  ...
  teams: [
    {
      name: '北隊',
      shortName: 'N',
      roster: [{ name: '甲', jerseyNumber: '1', position: 'OH' as const }],
    },
    {
      name: '南隊',
      shortName: 'S',
      roster: [{ name: '乙', jerseyNumber: '1', position: 'L' as const }],
    },
  ],
}
      ...
      validateMatchSetup({
        ...
        teams: [
          valid.teams[0]!,
          {
            ...valid.teams[0]!,
            roster: [
              { name: '乙', jerseyNumber: '1', position: 'MB' },
              { name: '丙', jerseyNumber: '1', position: 'S' },
            ],
          },
        ],
      }),
    ...
    expect(
      validateMatchSetup({
        ...
        teams: [
          {
            ...valid.teams[0]!,
            roster: [{ ...valid.teams[0]!.roster[0]!, position: 'UNSPECIFIED' as const }],
          },
          valid.teams[1]!,
        ],
      }),
    ).toContain('參賽隊伍 1 的球員位置都必須選擇。')
  })
})
