  ...
  <section class="players-view">
    ...
    <div v-else-if="analytics" class="players-layout">
      <aside class="entity-list" aria-label="分析對象">
        <header>
          <div class="entity-mode" aria-label="分析方式">
            <button type="button" :class="{ active: viewMode === 'players' }" @click="viewMode = 'players'">球員</button>
            <button type="button" :class="{ active: viewMode === 'tracks' }" @click="viewMode = 'tracks'">片段 ID</button>
          </div>
