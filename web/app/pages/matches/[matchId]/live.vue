    ...
    <template v-else>
      ...
      <div class="live-stage">
        <div class="live-video">
          <iframe v-if="embedUrl" :src="embedUrl" :title="`${match.title} 直播`" allow="autoplay; encrypted-media; picture-in-picture; fullscreen" />
          <div v-else class="live-video__empty"><Radio :size="28" /><strong>直播尚未連結</strong></div>
          <a v-if="publicSourceUrl" class="live-video__source" :href="publicSourceUrl" target="_blank" rel="noopener">影音來源<ExternalLink :size="12" /></a>
        </div>
