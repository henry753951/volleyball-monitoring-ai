...
<template>
  <section class="space-y-6">
    ...
    <div v-if="authRequired || (viewerState.checked.value && !viewerState.viewer.value)" class="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-amber-900" role="status">目前需要登入才能查看場次。請確認開發身份或重新連線後再試。</div>
