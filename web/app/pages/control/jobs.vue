   ...
   <section class="jobs-page">
      ...
      <div class="jobs-content">
         ...
         >
            ...
            <div
               v-if="!jobs.length && !monitor.pending.value"
            ...
            >
               ...
               >
                  ...
                  <span
                     >{{ stageLabel(job.stage) }} · 回合
                     <code>{{ job.rallyId.slice(0, 8) }}</code></span
                  >
               </div>
               <span
                  class="job-state"
               ...
               <span
                  class="job-worker"
                  role="cell"
                  >{{ job.workerInstanceKey || "未分配" }}</span
               >
               <div
                  class="job-progress"
                  role="cell"
