...
export interface CaptureTimelineRange { start_us: string; end_us: string; discontinuity: number }
...
export class MediaApiError extends Error {
  ...
  constructor(code: MediaErrorCode | string, message: string, status: number, details?: unknown) { super(message); this.name = 'MediaApiError'; this.code = code; this.status = status; this.details = details }
}
