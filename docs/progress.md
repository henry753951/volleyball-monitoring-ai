...
Open limitations: correction-draft creation, multi-user presence/soft locks and Phase 7 restart/backup/retention acceptance remain. Production identity provider and retention durations remain explicit deployment decisions and are not invented here.
