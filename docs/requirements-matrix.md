...
| Annotation Z/Space/X/</>/?/Enter | strict WS schema + Prisma model | WS echo only | UI controls/mask shell | state unit test | scaffolded | two clients, conflict/reconnect, immutable submit |
